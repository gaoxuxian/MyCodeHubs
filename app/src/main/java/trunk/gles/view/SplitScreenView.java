...
import com.xx.avlibrary.gl.filter.innovation.SplitScreenFilterV1;
import trunk.R;
...
public class SplitScreenView extends GLSurfaceView implements GLSurfaceView.Renderer
{
    ...
    public void onDrawFrame(GL10 gl)
    {
        ...
        mDisplayFilter.setTextureWH(mBmpToTextureFilter.getTextureW(), mBmpToTextureFilter.getTextureH());
