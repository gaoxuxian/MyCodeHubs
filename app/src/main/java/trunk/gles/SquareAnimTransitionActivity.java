...
import trunk.gles.view.SquareAnimTransitionView;
import trunk.gles.view.ZoomTransitionView;
import util.PxUtil;

public class SquareAnimTransitionActivity extends BaseActivity
{
    private SquareAnimTransitionView mItemView;
    ...
    {
        mItemView = new SquareAnimTransitionView(context);
