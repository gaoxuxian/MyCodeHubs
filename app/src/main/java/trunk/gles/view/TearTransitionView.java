 ...
 */
public class TearTransitionView extends GLSurfaceView implements GLSurfaceView.Renderer
{
    private BmpToTextureFilter mFrontTextureFilter;
    private BmpToTextureFilter mBackTextureFilter;
    private TearTransitionFilter mTearTransitionFilter;

    private long mStartTime;

    public TearTransitionView(Context context)
    {
        super(context);
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config)
    {
        ...
        mTearTransitionFilter = new TearTransitionFilter(getContext());
        mTearTransitionFilter.onSurfaceCreated(config);
    }
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height)
    {
        ...
        mTearTransitionFilter.setTextureWH(mFrontTextureFilter.getTextureW(), mFrontTextureFilter.getTextureH());
        mTearTransitionFilter.onSurfaceChanged(width, height);
    }
    ...
    public void onDrawFrame(GL10 gl)
    {
        ...
        mTearTransitionFilter.setStartTimeValue(mStartTime);
        mTearTransitionFilter.setTimeValue(System.currentTimeMillis());
        mTearTransitionFilter.onDrawFrame(front, back);
    }
    ...
    public void onPause()
    {
        ...
        if (mTearTransitionFilter != null)
        {
            mTearTransitionFilter.destroy();
        }
    }
}
