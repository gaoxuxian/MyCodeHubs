...
public class SingleDragTransitionActivity extends BaseActivity
{
    private SingleDragTransitionView mItemView;
    ...
    {
        mItemView = new SingleDragTransitionView(context);
