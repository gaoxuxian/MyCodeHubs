...
import trunk.gles.view.TearTransitionView;
import util.PxUtil;

public class TearTransitionActivity extends BaseActivity
{
    private TearTransitionView mItemView;
    ...
    {
        mItemView = new TearTransitionView(context);
