...
public class PreviewViewV2 extends View
{
    ...
    private PreviewViewListener mListener;
    ...
    public void setListener(PreviewViewListener listener)
    {
        ...
        if (!mEventLock && isBitmapValid(mImgBmp))
        {
            switch (event.getAction() & MotionEvent.ACTION_MASK)
            {
                ...
                case MotionEvent.ACTION_MOVE:
                {
                    ...
                    mHasMoveEvent = moveSpace > PxUtil.sU_1080p(40);
                    ...
                    else
                    {
                        ...
                        else if (!mCancelWaterMarkClickEvent && mTouchArea == TouchArea.water_mark)
                        {
                            ...
                            mCancelWaterMarkClickEvent = moveSpace > PxUtil.sU_1080p(40);
                        }
                    }
                    break;
                }
