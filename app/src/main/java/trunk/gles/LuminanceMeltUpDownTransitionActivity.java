...
public class LuminanceMeltUpDownTransitionActivity extends BaseActivity
{
    private LuminanceMeltUpDownTransitionView mItemView;
    ...
    {
        mItemView = new LuminanceMeltUpDownTransitionView(context);
