 ...
 */
public class RandomSquareTransitionView extends GLSurfaceView implements GLSurfaceView.Renderer
{
    private BmpToTextureFilter mFrontTextureFilter;
    private BmpToTextureFilter mBackTextureFilter;
    private RandomSquaresTransitionFilter mSingleDragTransitionFilter;

    private long mStartTime;

    public RandomSquareTransitionView(Context context)
    {
        super(context);
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config)
    {
        ...
        mSingleDragTransitionFilter = new RandomSquaresTransitionFilter(getContext());
