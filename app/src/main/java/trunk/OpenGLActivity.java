...
public class OpenGLActivity extends BaseActivity {
    ...
    public void onCreateBaseData() throws Exception {
        ...
        intent = new Intent();
        cls = Class.forName(activity_package_path + "ColorScanTransitionActivity");
        intent.setClass(this, cls);
        map.put(ActivityItemAdapter.DataKey.CLASS_INTENT, intent);
        mData.add(map);
        ...
        intent = new Intent();
        cls = Class.forName(activity_package_path + "ColorScanTransitionActivityV2");
        intent.setClass(this, cls);
        map.put(ActivityItemAdapter.DataKey.CLASS_INTENT, intent);
        mData.add(map);

        map = new SparseArray<>();
        map.put(ActivityItemAdapter.DataKey.ITEM_TITLE, "转场- 颗粒感 -动画");
        intent = new Intent();
        cls = Class.forName(activity_package_path + "ParticlesTransitionActivity");
        intent.setClass(this, cls);
        map.put(ActivityItemAdapter.DataKey.CLASS_INTENT, intent);
        mData.add(map);

        map = new SparseArray<>();
        map.put(ActivityItemAdapter.DataKey.ITEM_TITLE, "转场- 撕裂感 -动画");
        intent = new Intent();
        cls = Class.forName(activity_package_path + "TearTransitionActivity");
        intent.setClass(this, cls);
        map.put(ActivityItemAdapter.DataKey.CLASS_INTENT, intent);
        mData.add(map);

        map = new SparseArray<>();
        map.put(ActivityItemAdapter.DataKey.ITEM_TITLE, "转场- 模糊放大 -动画");
        intent = new Intent();
        cls = Class.forName(activity_package_path + "FuzzyZoomTransitionActivity");
        intent.setClass(this, cls);
        map.put(ActivityItemAdapter.DataKey.CLASS_INTENT, intent);
        mData.add(map);

        map = new SparseArray<>();
        map.put(ActivityItemAdapter.DataKey.ITEM_TITLE, "转场- 单方向拉扯 -动画");
        intent = new Intent();
        cls = Class.forName(activity_package_path + "SingleDragTransitionActivity");
        intent.setClass(this, cls);
        map.put(ActivityItemAdapter.DataKey.CLASS_INTENT, intent);
        mData.add(map);

        map = new SparseArray<>();
        map.put(ActivityItemAdapter.DataKey.ITEM_TITLE, "转场- 随机方块透明叠化 -动画");
        intent = new Intent();
        cls = Class.forName(activity_package_path + "RandomSquareTransitionActivity");
        intent.setClass(this, cls);
        map.put(ActivityItemAdapter.DataKey.CLASS_INTENT, intent);
        mData.add(map);
    }
