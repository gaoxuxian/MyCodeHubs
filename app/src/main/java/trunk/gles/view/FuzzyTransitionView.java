 ...
 */
public class FuzzyTransitionView extends GLSurfaceView implements GLSurfaceView.Renderer
{
    private BmpToTextureFilter mFrontTextureFilter;
    private BmpToTextureFilter mBackTextureFilter;
    private FuzzyTransitionFilter mFuzzyTransitionFilter;

    private long mStartTime;

    public FuzzyTransitionView(Context context)
    {
        super(context);
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config)
    {
        ...
        mFuzzyTransitionFilter = new FuzzyTransitionFilter(getContext());
        mFuzzyTransitionFilter.onSurfaceCreated(config);
    }
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height)
    {
        ...
        mFuzzyTransitionFilter.setTextureWH(mFrontTextureFilter.getTextureW(), mFrontTextureFilter.getTextureH());
        mFuzzyTransitionFilter.onSurfaceChanged(width, height);
    }
    ...
    public void onDrawFrame(GL10 gl)
    {
        ...
        mFuzzyTransitionFilter.setStartTimeValue(mStartTime);
        mFuzzyTransitionFilter.setTimeValue(System.currentTimeMillis());
        mFuzzyTransitionFilter.onDrawFrame(front, back);
    }
    ...
    public void onPause()
    {
        ...
        if (mFuzzyTransitionFilter != null)
        {
            mFuzzyTransitionFilter.destroy();
        }
    }
}
