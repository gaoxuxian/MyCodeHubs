...
public class ParticlesTransitionFilter extends GPUImageTransitionFilter
{
    ...
    {
        super(context, GLUtil.readShaderFromRaw(context, R.raw.vertex_image_default), GLUtil.readShaderFromRaw(context, R.raw.fragment_transition_particles));
    }
    ...
    {
        return GPUFilterType.TRANSITION_PARTICLES;
    }
