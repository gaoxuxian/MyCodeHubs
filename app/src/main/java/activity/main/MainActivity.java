...
public class MainActivity extends BaseActivity {
    ...
    public static final String activity_main_package_path = "activity.main.";
    ...
    public void onCreateBaseData() throws Exception {
        ...
        Class cls = Class.forName(activity_main_package_path + "AndroidActivity");
        ...
        intent = new Intent();
        cls = Class.forName(activity_main_package_path + "OpenGLActivity");
        intent.setClass(this, cls);
        map.put(ActivityItemAdapter.DataKey.CLASS_INTENT, intent);
        mData.add(map);
    }
