package com.xx.avlibrary.gl.fbo;

import android.opengl.GLES20;

class TextureFboMgr20 extends AbsFboMgr
{
    ...
    TextureFboMgr20(int width, int height, int size, boolean color, boolean depth, boolean stencil)
    {
