 ...
 */
public class SingleDragTransitionFilter extends GPUImageTransitionFilter
{
    private int vStrengthHandle;

    public SingleDragTransitionFilter(Context context)
    {
        super(context, GLUtil.readShaderFromRaw(context, R.raw.vertex_image_default), GLUtil.readShaderFromRaw(context, R.raw.fragment_transition_quick_sand));
    }
    ...
    {
        return GPUFilterType.TRANSITION_SINGLE_DRAG;
    }
