...
import trunk.gles.view.FuzzyZoomTransitionView;
import trunk.gles.view.ParticlesTransitionView;
import util.PxUtil;

public class FuzzyZoomTransitionActivity extends BaseActivity
{
    private FuzzyZoomTransitionView mItemView;
    ...
    {
        mItemView = new FuzzyZoomTransitionView(context);
