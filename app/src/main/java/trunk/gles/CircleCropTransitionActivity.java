...
import trunk.gles.view.CircleCropTransitionView;
import trunk.gles.view.FuzzyTransitionView;
import util.PxUtil;

public class CircleCropTransitionActivity extends BaseActivity
{
    private CircleCropTransitionView mItemView;
    ...
    {
        mItemView = new CircleCropTransitionView(context);
