 ...
 */
public class RotateTransitionView extends GLSurfaceView implements GLSurfaceView.Renderer
{
    private BmpToTextureFilter mFrontTextureFilter;
    private BmpToTextureFilter mBackTextureFilter;
    private RotateTransitionFilter mFuzzyTransitionFilter;

    private long mStartTime;

    public RotateTransitionView(Context context)
    {
        super(context);
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config)
    {
        ...
        mFuzzyTransitionFilter = new RotateTransitionFilter(getContext());
