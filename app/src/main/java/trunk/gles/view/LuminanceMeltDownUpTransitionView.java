 ...
 */
public class LuminanceMeltDownUpTransitionView extends GLSurfaceView implements GLSurfaceView.Renderer
{
    private BmpToTextureFilter mFrontTextureFilter;
    private BmpToTextureFilter mBackTextureFilter;
    private LuminanceMeltTransitionFilter mLuminanceMeltTransitionFilter;

    private long mStartTime;

    public LuminanceMeltDownUpTransitionView(Context context)
    {
        super(context);
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config)
    {
        ...
        mLuminanceMeltTransitionFilter = new LuminanceMeltTransitionFilter(getContext());
        mLuminanceMeltTransitionFilter.onSurfaceCreated(config);
        mLuminanceMeltTransitionFilter.setDirection(false);
    }
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height)
    {
        ...
        mLuminanceMeltTransitionFilter.setTextureWH(mFrontTextureFilter.getTextureW(), mFrontTextureFilter.getTextureH());
        mLuminanceMeltTransitionFilter.onSurfaceChanged(width, height);
    }
    ...
    public void onDrawFrame(GL10 gl)
    {
        ...
        mLuminanceMeltTransitionFilter.setStartTimeValue(mStartTime);
        mLuminanceMeltTransitionFilter.setTimeValue(System.currentTimeMillis());
        mLuminanceMeltTransitionFilter.onDrawFrame(front, back);
    }
    ...
    public void onPause()
    {
        ...
        if (mLuminanceMeltTransitionFilter != null)
        {
            mLuminanceMeltTransitionFilter.destroy();
        }
    }
}
