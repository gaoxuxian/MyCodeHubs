 ...
 */
public class LuminanceMeltUpDownTransitionView extends GLSurfaceView implements GLSurfaceView.Renderer
{
    ...
    public LuminanceMeltUpDownTransitionView(Context context)
    {
        super(context);
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config)
    {
        ...
        mLuminanceMeltTransitionFilter.setDirection(true);
    }
