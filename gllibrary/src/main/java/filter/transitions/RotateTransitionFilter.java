 ...
 */
public class RotateTransitionFilter extends GPUImageTransitionFilter
{
    public RotateTransitionFilter(Context context)
    {
        super(context, GLUtil.readShaderFromRaw(context, R.raw.vertex_image_default), GLUtil.readShaderFromRaw(context, R.raw.fragment_transition_rotate));
    }
    ...
    {
        return GPUFilterType.TRANSITION_ROTATE;
    }
